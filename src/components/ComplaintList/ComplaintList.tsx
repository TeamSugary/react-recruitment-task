...
const ComplaintList: React.FC<ComplaintListProps> = ({ complaints, isLoading, error, onRefresh }) => {
  const [currentPage, setCurrentPage] = useState(1)
  const [filterOption, setFilterOption] = useState<FilterOption>("all")
  const [sortOption, setSortOption] = useState<SortOption>("newest")
  const [searchQuery, setSearchQuery] = useState("")

  // Filter complaints based on selected option and search query
        ...
        <div className="filter-sort-container">
          <div className="dropdown">
            ...
            <div className="dropdown-menu">
              <button className={filterOption === "all" ? "active" : ""} onClick={() => handleFilterChange("all")}>
                All Complaints
              </button>
              <button
          ...
          <div className="dropdown">
            ...
            <div className="dropdown-menu">
              <button className={sortOption === "newest" ? "active" : ""} onClick={() => handleSortChange("newest")}>
                Newest First
              </button>
              <button className={sortOption === "oldest" ? "active" : ""} onClick={() => handleSortChange("oldest")}>
                Oldest First
              </button>
            </div>
          </div>
